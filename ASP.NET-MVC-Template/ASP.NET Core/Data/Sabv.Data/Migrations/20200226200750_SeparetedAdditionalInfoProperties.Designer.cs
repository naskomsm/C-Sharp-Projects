...
namespace Sabv.Data.Migrations
{
    ...
    [Migration("20200226200750_SeparetedAdditionalInfoProperties")]
    partial class SeparetedAdditionalInfoProperties
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sabv.Data.Models.AdditioalInfoFiles.ComfortInfo", b =>
                {
                    ...
                    b.ToTable("ComfortInfo");
                });

            modelBuilder.Entity("Sabv.Data.Models.AdditioalInfoFiles.ExteriorInfo", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("ExteriorInfo");
                });

            modelBuilder.Entity("Sabv.Data.Models.AdditioalInfoFiles.OtherInfo", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Sabv.Data.Models.AdditioalInfoFiles.SafetyInfo", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("SafetyInfo");
                });

            modelBuilder.Entity("Sabv.Data.Models.AdditionalInfoFiles.AdditionalInfo", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");

                    b.Property<int>("ComfortInfoId")
                        .HasColumnType("int");

                    b.Property<string>("ComfortInfoId1")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<int>("ExteriorInfoId")
                        .HasColumnType("int");

                    b.Property<string>("ExteriorInfoId1")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("OtherInfoId1")
                        .HasColumnType("nvarchar(450)");

                    b.Property<int>("SafetyInfoId")
                        .HasColumnType("int");

                    b.Property<string>("SafetyInfoId1")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("ComfortInfoId1");

                    b.HasIndex("ExteriorInfoId1");

                    b.HasIndex("IsDeleted");

                    b.HasIndex("OtherInfoId1");

                    b.HasIndex("SafetyInfoId1");
            ...
            modelBuilder.Entity("Sabv.Data.Models.AdditionalInfoFiles.AdditionalInfo", b =>
                {
                    b.HasOne("Sabv.Data.Models.AdditioalInfoFiles.ComfortInfo", "ComfortInfo")
                        .WithMany()
                        .HasForeignKey("ComfortInfoId1");

                    b.HasOne("Sabv.Data.Models.AdditioalInfoFiles.ExteriorInfo", "ExteriorInfo")
                        .WithMany()
                        .HasForeignKey("ExteriorInfoId1");

                    b.HasOne("Sabv.Data.Models.AdditioalInfoFiles.OtherInfo", "OtherInfo")
                        .WithMany()
                        .HasForeignKey("OtherInfoId1");

                    b.HasOne("Sabv.Data.Models.AdditioalInfoFiles.SafetyInfo", "SafetyInfo")
                        .WithMany()
                        .HasForeignKey("SafetyInfoId1");
                });
            ...
            modelBuilder.Entity("Sabv.Data.Models.Post", b =>
                {
                    b.HasOne("Sabv.Data.Models.AdditionalInfoFiles.AdditionalInfo", "AdditionalInfo")
                        .WithMany("Posts")
